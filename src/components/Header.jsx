      ...
      >
        ...
        >
          <g fill="none" fillRule="evenodd">
            <path
              ...
              fill="currentColor"
              className={`${
                isSidebarOpen ? "text-[#FFF]" : "text-[#242A45]"
              } lg:text-[#242A45]`}
              fillRule="nonzero"
            />
            <g>
              <circle
                fill="currentColor"
                className={`${
                  isSidebarOpen ? "text-[#FFF]" : "text-[#5267DF]"
                } lg:text-[#5267DF]`}
                cx="12.5"
                cy="12.5"
                r="12.5"
              ...
              <path
                ...
                fill="currentcolor"
                className={`${
                  isSidebarOpen ? "bg-veryDarkBlue/90" : "text-white"
                } lg:text-white`}
              />
            </g>
          </g>
        ...
        {isSidebarOpen ? (
          <img
            src={closeIcon}
            alt="closeIcon"
            className="w-[18px] cursor-pointer lg:hidden"
            onClick={() => {
