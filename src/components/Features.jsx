        ...
        >
          {features.map((feature, index) => (
            <motion.li
              ...
              } text-center text-grayishBlue capitalize text-xl py-4 cursor-pointer hover:text-softRed border-t border-gray-300 max-lg:last:border-b lg:border-t-0 lg:px-12 max-lg:[--hidden-opacity:0%] max-lg:[--shown-opacity:100%] max-lg:[--hidden-scale:0%] max-lg:[--shown-scale:100%] duration-500`}
              onClick={() => {
                handleClick(index);
              }}
              transition={{
